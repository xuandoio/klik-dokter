...
type Serializer interface {
	SerializeItem(resource Item) interface{}
	SerializeCollection(resource Collection) interface{}
	SerializeError(resource Error) interface{}
	SerializeNil() interface{}
}
...
func (j JSONSerializer) SerializeCollection(resource Collection) interface{} {
	var formattedCollection = make([]interface{}, 0)
...
func (j JSONSerializer) SerializeNil() interface{} {
	return j
}

func (j JSONSerializer) SerializeError(resource Error) interface{} {
